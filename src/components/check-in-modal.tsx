    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="space-y-6 py-4">
          ...
          <div>
            <h3 className="text-lg font-medium mb-3">Thêm dịch vụ (nếu có)</h3>
            <div className="flex items-center gap-2 mb-2">
              <Select
                value={currentServiceType}
                onValueChange={setCurrentServiceType}
              >
                <SelectTrigger>
              ...
              <Select
                ...
                onValueChange={setCurrentServiceQuantity}
              >
            ...
            {services.length > 0 && (
              <div className="space-y-2 mt-4">
                {services.map((service, index) => (
                  <div
                    key={index}
                    className="flex justify-between px-3 py-2 bg-gray-100 rounded"
                  >
