  ...
  return (
    <div className="border rounded-lg overflow-hidden">
            ...
            {currentItems.length > 0 ? (
              currentItems.map((guest) => (
                <TableRow key={guest.id}>
                  ...
                  <TableCell className="font-medium max-w-[120px] truncate">{guest.name}</TableCell>
                  <TableCell className="hidden md:table-cell">{guest.idNumber}</TableCell>
      ...
      <div className="flex flex-wrap items-center justify-between px-4 py-2 border-t gap-2">
        <div className="text-sm">Tổng cộng {filteredGuests.length} khách hàng</div>
