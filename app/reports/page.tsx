        ...
        <div className="h-[300px]">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={serviceData} layout="vertical">
              ...
              <Tooltip />
              <Legend />
              <Bar dataKey="laundry" name="Doanh thu giặt là (Triệu VNĐ)" fill="#93C5FD" barSize={20} />
              <Bar dataKey="beverage" name="Doanh thu nước ngọt (Triệu VNĐ)" fill="#60A5FA" barSize={20} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
