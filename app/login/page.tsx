...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen">
      ...
      <div className="hidden md:flex w-[68px] border-r bg-background flex-col items-center py-4">
      ...
      <div className="flex-1 flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 p-6 md:p-10 flex items-center justify-center">
          <div className="max-w-[400px] w-full">
            <h1 className="text-2xl md:text-3xl font-bold mb-2">Chào mừng</h1>
            ...
            <div className="mt-16 border-t pt-6">
              <p className="text-sm text-muted-foreground">Cần trợ giúp? Liên hệ hỗ trợ qua Email</p>
        ...
        <div className="hidden md:flex w-1/2 bg-purple-600 p-10 items-center justify-center">
